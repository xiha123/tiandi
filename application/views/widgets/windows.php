		...
		<div class="login-content">
			<form action="" id="register">
				<ul>
					...
					<li class="login-click"> <label><input type="checkBox" id="reg_ok"><span>同意并接受服务条款</span></label><label class="fr" style="margin-right:40px;"><input type="checkBox" id="reg_god"><span>注册成为大神</span></label></li>
