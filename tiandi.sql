...
--
-- Host: localhost
-- Generation Time: 2015-08-06 14:20:34
-- 服务器版本： 5.6.11
-- PHP Version: 5.5.1
...
(1, '为什么说话时觉得自己说得很有道理，事后听录音时却感觉不对？', 3, 0, 0, '[1]', '[]', '[{"name":"说话"},{"name":"道理"},{"name":"录音"},]', 0, 0, 2, 0, 0, '2015-08-05 11:54:24', 0, 8, '[]', '[]', '[{"id":"3"}]', '[]'),
(2, '测试测试测试测试测试测试测试测试', 3, 0, 0, '[2]', '[]', '[{"name":"测试"},{"name":"撒旦撒测试"},{"name":"1321"},]', 1, 0, 1, 0, 0, '2015-08-05 15:04:46', 0, 8, '[]', '[]', '[{"id":"3"}]', '[]');
...
(1, '<p>这个场景是：在与人对话时，往往感到自己正在侃侃而谈，似乎自己说得很棒，然而事后再听录音时却感觉自己二二的，说话的语调也不像是自己，完全没有之前感觉那么好，这是为什么？<br/>————————————————————————————————<br/>其实让我想到这个问题的原因是我当时在跟人微信语音，说完发送出去再自己听的时候感觉不像自己的声音，或者说感觉自己的声音好难听。。跟讲话时反馈给自己大脑的声音不一样，看了很多答案感觉应该是大家说的骨传导和空气传导的问题，谢谢大家</p>', 0, 3, '2015-08-05 11:54:24', 1, ''),
(2, '<p>在这里输入您对问题的描述!测试测试测试测试测试测试测试测试测试</p>', 0, 3, '2015-08-05 15:04:46', 1, '测试测试测试');
...
INSERT INTO `tag` (`id`, `type`, `count`, `name`, `content`) VALUES
(1, 1, 0, '说话', ''),
(2, 1, 0, '道理', ''),
(3, 1, 0, '录音', ''),
(4, 1, 0, '测试', ''),
